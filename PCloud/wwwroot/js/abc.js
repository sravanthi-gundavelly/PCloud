...
(function ($) {
    ...
    Drupal.behaviors.mainMenuToggle = {
        attach: function attach(context, settings) {
            var $context = $(context);
            var $mainMenuToggle = $context.find("#main-menu-toggle");
            var $mainMenu = $context.find("#block-headernavigation");
...
(function ($) {
    ...
    Drupal.behaviors.footerAddressesToggle = {
        attach: function attach(context, settings) {
            var $context = $(context);
            $context.on('click', '#block-views-block-office-locations h2', function () {
...
(function ($) {
    ...
    Drupal.behaviors.leadership = {
        attach: function attach(context, settings) {
            var $context = $(context);
            var $toggleBtn = $context.find(".leader a.leader-more");
            $toggleBtn.on("click", function (e) {
                e.preventDefault();
                var $item = $(this).closest(".leader-item");
                var $wrapper = $(this).closest(".leader-item-list");
                var $itemBox = $item.find(".leader-info-box");
                ...
                var open = function open() {
                    ...
                    var $box = $("<li>").addClass("leader-item leader-info-box").data("item-index", index).html($itemBox.clone().children());
                ...
                var $opened = $wrapper.find(".leader-item.leader-info-box");
...
(function ($) {
    ...
    Drupal.behaviors.formAnimation = {
        attach: function attach(context, settings) {
            var $context = $(context);
            var $form = $context.find(".js-form-item");
            ...
            $input.each(function () {
                ...
                if ($this.val()) {
                    $this.parent().find('label').addClass("animation");
                }
            });
            $input.focusin(function () {
                var $animated = $(this).parent().find('label');
            ...
            var $textareaLabel = $textarea.parent().parent().find('label');
            $textarea.focusin(function () {
                return $textareaLabel.addClass("animation");
            }).focusout(function () {
                if ($textarea.val().length === 0) {
                    $textareaLabel.removeClass("animation");
                }
            });
            $(context).find('input[autofocus]').once('[autofocus]').trigger('focus');
        }
    };
})(jQuery);;
